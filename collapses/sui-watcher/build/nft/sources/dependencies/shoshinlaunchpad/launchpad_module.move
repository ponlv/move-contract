module shoshinlaunchpad::launchpad_module {
        ...
        * 
        */
        public entry fun buy_deposit_nft<T: store + key>(whitelist_container: &mut WhitelistContainer ,launchpad: &mut Launchpad, round_id: ID, amount: u64, coin: Coin<SUI>, clock: &Clock, ctx: &mut TxContext) {
                let amount_index = 0;
                while(amount < amount){
                        // check owner
        ...
        * 
        */
        public entry fun make_buy_public_deposit_nft<T: store + key>(whitelist_container: &mut WhitelistContainer ,launchpad: &mut Launchpad, round_id: ID, amount: u64, coin: Coin<SUI>, clock: &Clock, ctx: &mut TxContext) {
                let amount_index = 0;
        ...
        * 
        */
        public entry fun make_buy_mint_nft<T: store + key>(whitelist_container: &mut WhitelistContainer, launchpad: &mut Launchpad, round_id: ID, amount: u64, coin: Coin<SUI>, clock: &Clock, ctx: &mut TxContext) {
                let amount_index = 0;
                while(amount_index < amount) {
                        // check owner
                        assert!(launchpad.owner_address != tx_context::sender(ctx), EWasOwned);
        ...
        * 
        */
        public entry fun make_buy_public_mint_nft<T: store + key>(whitelist_container: &mut WhitelistContainer, launchpad: &mut Launchpad, round_id: ID, amount: u64, coin: Coin<SUI>, clock: &Clock, ctx: &mut TxContext) {
                let amount_index = 0;
                while(amount_index < amount) {
                        // check owner
                        assert!(launchpad.owner_address != tx_context::sender(ctx), EWasOwned);
