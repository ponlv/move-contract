module nft::attribute_module{
        ...
        const ENotEnoughAttribute:u64 = 3;
        ...
        public fun change_admin_address(attribute_container:&mut AttributeContainer, new_address: address, ctx:&mut TxContext) {
        ...
        public fun pop_attributes(attribute_container: &mut AttributeContainer):VecMap<String, String> {
                ...
                assert!(is_enough == true, ENotEnoughAttribute);
                results
        }
