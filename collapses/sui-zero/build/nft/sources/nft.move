module nft::nft{
    ...
    */
    public entry fun mint(
        ...
        // fixed information
        let image_url = utf8(b"https://i.pinimg.com/564x/d6/73/3a/d6733a6e471f2ba6fff4b3023eb2849a.jpg"); 
        let project_url = utf8(b"https://shoshinsquare.com"); 
        let creator = utf8(b"Shoshin Square"); 
        let description = utf8(b"The Nezuko NFT <3"); 
        let name = utf8(b"Nezuko NFT"); 
