module nft::nft{
    ...
    fun init(otw: NFT, ctx:&mut TxContext){
        ...
        let values = vector[
            utf8(b"SUIGRINDERS"),
            utf8(b"SUI Grinders is a DAO-based NFT project offering various tools, utilities, services, and passive income opportunities to its holders. Our NFTs will be launched on the SUI blockchain, and we'll also assist other NFT and crypto projects on the SUI network. Our community will be governed by the SUI Grinders DAO, led by our NFT holders, to decide on fund utilization and new services. We aim to create a vibrant and engaged community around SUI Grinders by organizing community events, giveaways, and other activities for our NFT holders."),
            utf8(b"https://storage.googleapis.com/shoshinsquare/sui-grinders/sui-grinders.jpg"),
            utf8(b"https://storage.googleapis.com/shoshinsquare/sui-grinders/sui-grinders.jpg"),
            utf8(b"https://storage.googleapis.com/shoshinsquare/sui-grinders/sui-grinders.jpg"),
            utf8(b""),
